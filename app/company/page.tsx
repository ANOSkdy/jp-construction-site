export default function CompanyPage() {
  return (
    <div className="mx-auto max-w-5xl px-6 py-16 text-neutral-100">
      ...
      <div className="overflow-x-auto rounded border border-neutral-800 bg-neutral-950/80 shadow-lg">
        <table className="min-w-full text-sm">
          <tbody>
            <tr className="border-b border-neutral-800">
              <th className="w-40 bg-neutral-900 px-4 py-3 text-left text-xs font-semibold text-neutral-200">
                会社名
              </th>
              <td className="px-4 py-3 text-neutral-100">建設株式会社</td>
            </tr>
            <tr className="border-b border-neutral-800">
              <th className="bg-neutral-900 px-4 py-3 text-left text-xs font-semibold text-neutral-200">
                所在地
              </th>
